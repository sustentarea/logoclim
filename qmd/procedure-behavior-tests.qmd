...
```{r}
testthat::test_that("quartile [0 1 2 3 4]", {
  results |>
    extract2("table") |>
...
```{r}
testthat::test_that("quartile [0 1 2 3 4 5]", {
  results |>
    extract2("table") |>
...
```{r}
testthat::test_that("single-quote", {
  results |>
    extract2("table") |>
    pull(single_quote_1) |>
    expect_equal("'1'")
...
```{r}
testthat::test_that("str-to-num-month", {
  results |>
    extract2("table") |>
...
```{r}
testthat::test_that("unique-outliers", {
  results |>
    extract2("table") |>
