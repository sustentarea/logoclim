...
[Procedures](https://docs.netlogo.org/programming.html#procedures) can produce unexpected results and have side effects that may not be captured during the development process. This document addresses these challenges by providing pre-defined expectations for each procedure's behavior.
...
Expectations were validated using the [`testthat`](https://testthat.r-lib.org/) and [`checkmate`](https://mllg.github.io/checkmate/) [@lang2017] R packages.
