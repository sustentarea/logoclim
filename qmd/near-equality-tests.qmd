...
::: {.callout-note}
A local temporary directory is used to support debugging and to avoid permission issues that can occur when writing outside the project directory. This is especially relevant when running GitHub Actions on macOS runners.
:::
