# Release Notes {#sec-release-notes}
...
- Based on Seth Tisue's [suggestion](https://github.com/NetLogo/NetLogo/issues/2554), `LogoClim` represents missing values as `false`. This resolves issues with primitives like `export-world` and `import-world` (see [GIS Known Issues](https://docs.netlogo.org/gis.html#known-issues)).
