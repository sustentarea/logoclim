...
- Based on [Seth Tisue's suggestion](https://github.com/NetLogo/NetLogo/issues/2554#issuecomment-3293429697), `LogoClim` represents missing values as `false`. This resolves issues with primitives like `export-world` and `import-world` (see [GIS Known Issues](https://docs.netlogo.org/gis.html#known-issues)).
...
- A first draft of `LogoClim` User Manual, now available at [sustentarea.github.io/logoclim](https://sustentarea.github.io/logoclim/). The manual is a work in progress and will be continuously updated.
