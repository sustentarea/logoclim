...
::: {.callout-warning}
This is temporary. Disregard this callout block.

```{r}
# data_series_dir <- fs::path(data_dir, "historical-climate-data")
data_series_dir <- fs::path(data_dir, "World", "historical-monthly-weather-data")
# data_series_dir <- fs::path(data_dir, "future-climate-data")
```
:::
...
Choose one of the following options for `wc_raw_data_series_dir`.

```{r}
#| eval: false

wc_raw_data_series_dir <- file.path(
  wc_raw_data_dir,
