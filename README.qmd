...
To run the model, make sure to download all files in the [`nlogox`](nlogox) folder. Note that climate data from WorldClim is required but not included in this repository; see the next section for instructions on obtaining and preparing the data.
