...
You can download the latest version of the model [here](https://github.com/danielvartan/logoclim). Extract the files and locate `logoclim.nlogo` in the `nlogo` folder.
