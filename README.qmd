...
[![OSF DOI](https://img.shields.io/badge/DOI-10.17605/OSF.IO/EAPZU-1284C5.svg)](https://doi.org/10.17605/OSF.IO/EAPZU)
...
These datasets can be reproduced by running the [Quarto](https://quarto.org/) notebooks located in the `qmd` folder. To create custom datasets, simply modify the notebooks to suit your requirements.
...
The `LogoClim` code is licensed under the [MIT License](https://opensource.org/license/mit).
