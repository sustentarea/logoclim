...
We prepared a separate test model called [`Logônia`](https://github.com/sustentarea/logonia), to serve as a fun example of how to integrate `LogoClim` into your model.
