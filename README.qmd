...
To get started, ensure you have [NetLogo](https://ccl.northwestern.edu/netlogo) installed. This model was developed using NetLogo 6.4, so it is recommended to use this version or later.
...
You can download the latest release of the model in the [GitHub Releases](https://github.com/sustentarea/logoclim/releases/latest). To access the development version, clone, or download this repository.
